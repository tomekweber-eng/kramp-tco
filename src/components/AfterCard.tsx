...
export default function AfterCard({
  ...
  return (
    <div className="relative rounded-xl bg-kramp-red-tint border border-kramp-red/15 px-3 py-2 shadow-sm overflow-hidden">
      <span
        aria-hidden
      ...
      <div className="grid gap-1.5 pl-0.5">{children}</div>
    </div>
  );
}
